from util import *
# MODULES
from network_processing import gdfs_from_graph, load_simplified_consolidated_graph
...
# TODO: simplify to focus only on necessary plotting items for static+dynamic facility location results
...
def base_plot(rr: str, crs: str = 'WGS84'):
    filepath = os.path.join(FIGURE_DIR, rr + '_base_map.json')
